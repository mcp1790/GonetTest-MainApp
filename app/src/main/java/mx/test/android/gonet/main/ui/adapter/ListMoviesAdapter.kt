...
class ListMoviesAdapter(
    private var movies: HashMap<FlowEnum, ListMoviesModel>,
) : RecyclerView.Adapter<ListMoviesAdapter.ViewHolder>() {

    private val keysMap: ArrayList<String> = arrayListOf()
    private val listMap: ArrayList<List<MovieRawModel>> = arrayListOf()
    ...
    inner class ViewHolder(private val binding: GenericItemRecyclerViewBinding) :
        ...
        fun bind(category: String, moviesList: List<MovieRawModel>) {
            binding.apply {
